    ...
    async sendrequest(){
        if(this.state.categoryid == null | this.state.date == null | this.state.type == null | this.state.value == null){
            ...
            try{
                ...
                console.log(this.props.navigation.getParam('balance'));
                let new_balance = this.props.navigation.getParam('balance') - this.state.value;
